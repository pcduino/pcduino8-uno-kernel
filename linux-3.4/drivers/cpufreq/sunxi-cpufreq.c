...
struct cpufreq_frequency_table sunxi_freq_tbl[] = {
	{ .frequency = 60000  , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 120000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 240000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 312000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 408000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 504000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 600000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 648000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 720000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 816000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 912000 , .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1008000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1104000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1200000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1344000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1440000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
	{ .frequency = 1536000, .index = SUNXI_CLK_DIV(1, 2, 0, 0), },
