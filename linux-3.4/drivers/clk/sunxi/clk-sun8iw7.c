...
static const char *ahb2_parents[] = {"ahb1" , "pll_periph0_div2" , "" , ""};
...
void __init sunxi_init_clocks(void)
{
	...
	clk = clk_register_fixed_factor(NULL, "pll_periph0_div2", "pll_periph0", 0, 1, 2);
    clk_register_clkdev(clk, "pll_periph0_div2", NULL);
