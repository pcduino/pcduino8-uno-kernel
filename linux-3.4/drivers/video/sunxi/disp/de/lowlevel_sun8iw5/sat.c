...
__s32 SAT_Set_Sync_Para(__u32 sel)
{
	...
	sat_dev[sel]->sacsize.dwval = (sat_dev[sel]->sacsize.dwval & 0xf000f000) |
...
//			}
			memcpy((u8 *)(&sat_dev[sel]->satcbtab[0]), (u8 *)TABLE_CB[0], 256);
			memcpy((u8 *)(&sat_dev[sel]->satcrtab[0]), (u8 *)TABLE_CR[0], 256);
		}
...
//			}
			memcpy((u8 *)(&sat_dev[sel]->satcbtab[0]), (u8 *)TABLE_CB[1], 256);
			memcpy((u8 *)(&sat_dev[sel]->satcrtab[0]), (u8 *)TABLE_CR[1], 256);
		}
...
//			}
			memcpy((u8 *)(&sat_dev[sel]->satcbtab[0]), (u8 *)TABLE_CB[2], 256);
			memcpy((u8 *)(&sat_dev[sel]->satcrtab[0]), (u8 *)TABLE_CR[2], 256);
		}
		else
		{
//			for(i=0;i<64;i++)
...
//			}
			memcpy((u8 *)(&sat_dev[sel]->satcbtab[0]), (u8 *)TABLE_CB[3], 256);
			memcpy((u8 *)(&sat_dev[sel]->satcrtab[0]), (u8 *)TABLE_CR[3], 256);
		}
	}
#endif
	else
