...
static int request_fd_resource(void)
{
   ...
   fd_devp->iomap_addrs.regs_ccmu = (volatile void __iomem*)ioremap((phys_addr_t)CCMU_REGS_BASE, (unsigned long)1*1024);
	...
	if(fd_devp->mem_addr.mem_rtl_addr == NULL)
	{
	...
	if(fd_devp->mem_addr.mem_ftr_cfg_addr == NULL)
	{
	...
	if(fd_devp->mem_addr.mem_scale_img_addr == NULL)
	{
	...
	if(fd_devp->mem_addr.mem_tmpbuf_addr == NULL)
	{
	...
	if(fd_devp->mem_addr.mem_roi_addr == NULL)
	{
	...
	if(fd_devp->mem_addr.mem_sys_flag_addr == NULL)
	{
